            ...
            try:
                ...
                await asst.send_message(
                    ...
                    buttons=[
                        ...
                        Button.url(
                            "Repl",
                            "https://replit.com/@ThePandey/PandeyStringSession",
                        ),
                    ],
                )
                sys.exit()
                ...
                ftext = "**Pandey Client Error:** `Forward this to` @PandeySupportChat\n\n"
                ftext += "**Py-Pandey Version:** `" + str(pyver)
                ftext += "`\n**Pandey Version:** `" + str(ult_ver)
