...
from . import eod, eor, get_string, mediainfo, Pragyan_cmd
...
@Pragyan_cmd(pattern="setbio( (.*)|$)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@Pragyan_cmd(pattern="setname ?((.|//)*)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@Pragyan_cmd(pattern="setpic$", fullsudo=True)
async def _(ult):
    if not ult.is_reply:
...
@Pragyan_cmd(pattern="delpfp( (.*)|$)", fullsudo=True)
