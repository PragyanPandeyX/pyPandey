...
from . import async_searcher, get_random_user_data, get_string, re, Pragyan_cmd


@Pragyan_cmd(pattern="eod$")
async def diela(e):
...
@Pragyan_cmd(pattern="randomuser")
