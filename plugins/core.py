...
from pyPandey.startup.loader import load_addons

from . import LOGS, async_searcher, eod, get_string, safeinstall, Pragyan_cmd, un_plug


@Pragyan_cmd(pattern="install", fullsudo=True)
...
@Pragyan_cmd(pattern="getaddons( (.*)|$)", fullsudo=True)
