...
from . import HNDLR, eod, get_string, Pragyan_cmd


@Pragyan_cmd(pattern="(send|dm)( (.*)|$)", fullsudo=True)
async def dm(e):
...
@Pragyan_cmd(pattern="fwdreply( (.*)|$)", fullsudo=True)
async def _(e):
