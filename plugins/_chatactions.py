...
from pyPandey.dB import stickers
from pyPandey.dB.echo_db import check_echo
from pyPandey.dB.forcesub_db import get_forcesetting
from pyPandey.dB.gban_mute_db import is_gbanned
from pyPandey.dB.greetings_db import get_goodbye, get_welcome, must_thank
from pyPandey.dB.nsfw_db import is_profan
from pyPandey.fns.helper import check_reply_to, inline_mention
        ...
        if pdB.get_key("ULTROID_BANS"):
            try:
                ...
                if is_banned["is_banned"]:
                    ...
                    await ult.respond(
                        f'**@PandeyBans:** Banned user detected and banned!\n`{str(is_banned)}`.\nBan reason: {is_banned["reason"]}',
                    )
